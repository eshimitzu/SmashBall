...
namespace MoreMountains.NiceVibrations
{
	...
	public static class MMVibrationManager
	{
        ...
        private static long _selectionDuration;
        private static long _successDuration;
        private static long _warningDuration;
        private static long _failureDuration;
        public static long FailureDuration
        {
            get
            {
                if (_failureDuration == 0)
                {
                    long patterDuration = 0;
                    for (int i = 0; i < _failurePattern.Length; i++)
                    {
                        patterDuration += _failurePattern[i];
                    }
                    _failureDuration = patterDuration;
                }
                return _failureDuration;
            }
        }
        
        public static long WarningDuration
        {
            get
            {
                ...
                {
                    long patterDuration = 0;
                    for (int i = 0; i < _warningPattern.Length; i++)
                    {
                        patterDuration += _warningPattern[i];
                    }

                    _warningDuration = patterDuration;
                }
                return _warningDuration;
            }
        }
        
        public static long SuccessDuration
        {
            get
            {
                if (_successDuration == 0)
                {
                    long patterDuration = 0;
                    for (int i = 0; i < _successPattern.Length; i++)
                    {
                        patterDuration += _successPattern[i];
                    }
                    _successDuration = patterDuration;
                }
                return _successDuration;
            }
        }
        public static long SelectionDuration
        {
            get
            {
                if (_selectionDuration == 0)
                {
                    long patterDuration = 0;
                    for (int i = 0; i < _successPattern.Length; i++)
                    {
                    ...
                    _selectionDuration = patterDuration;
                }
