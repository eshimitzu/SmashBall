...
namespace Coffee.UIEffects.Editors
{
    ...
    {
        SerializedProperty _spDrawTargetTexture;
        ...
        {
            _spDrawTargetTexture = serializedObject.FindProperty("m_DrawTargetTexture");
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Effect setting.
            //================
            EditorGUILayout.PropertyField(_spDrawTargetTexture);
