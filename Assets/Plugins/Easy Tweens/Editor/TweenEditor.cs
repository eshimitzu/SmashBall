...
namespace EasyTweens
{
    ...
    public class TweenEditor : VisualElement, IDisposable
    {
        ...
        private static StyleSheet _stylesheetAsset;
        ...
        public TweenEditor(TweenAnimationEditor animationEditor, TweenBase t)
        {
            ...
            if (_visualTreeAsset == null)
                _visualTreeAsset = Resources.Load<VisualTreeAsset>("TweenEditor");

            _visualTreeAsset.CloneTree(this);

            if (_stylesheetAsset == null)
                _stylesheetAsset = Resources.Load<StyleSheet>("TweenEditor");

            this.styleSheets.Add(_stylesheetAsset);
            ...
            RegisterCallback<MouseDownEvent>(evt =>
            {
                    ...
                    ((VisualElement)evt.target).ClassListContains("unity-foldout__input"))
                {
                    ...
                    menu.AddItem(new GUIContent("Paste"), false, () =>
                    {
                        ...
                        {
                            Debug.LogError("Invalid copy data. Tween type mismatch. Destination: " + tween.GetType().Name +
        ...
        void BindProperties()
        {
            ...
            mainFoldout.SetValueWithoutNotify(tween.isUnfolded); 
            mainFoldout.RegisterValueChangedCallback(evt =>
            {
        ...
        public bool UpdateDelayDurationVisualization()
        {
            ...
            var linkedDelayMaxVal = tween.LinkedTweenDelay / animationDuration;
        ...
        void BindAdditionalParams()
        {
            ...
            foreach (var field in _additionalParamsToExpose)
            {
                ...
                if (field.FieldType == typeof(string) && shaderAttribute != null)
                {
                    ...
                    {
                        dropdownField.choices = new List<string> {"Current target is null"};
                    }
        ...
        public virtual void OnAllPropertiesBound()
        {
        }
